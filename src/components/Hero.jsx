...
const getVideoSrc=(index)=>`videos/hero-${index}.mp4`
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
        {isLoading && (
<div className='flex-center absolute z-[100] h-dvh bg-violet-50 w-screen overflow-hidden'>
...
<div>
    <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
        <div className='origin-center sclae-50 opacity-0 transition-all duration-500 ease-in hover:scale-100
         hover:opacity-100' onClick={handleMiniVdClick}>
...
<h1 className='special-font hero-heading text-blue-100'>redine<b>n</b>e</h1>
